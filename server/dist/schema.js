...
exports.privateChats = (0, pg_core_1.pgTable)("private_chat", {
    ...
    sender_id: (0, pg_core_1.integer)("sender_id").references(() => exports.user.pk_user_id, { onDelete: "cascade" }).notNull(),
    recipient_id: (0, pg_core_1.integer)("recipient_id").references(() => exports.user.pk_user_id, { onDelete: "cascade" }).notNull(),
    created_at: (0, pg_core_1.timestamp)("created_at").notNull().default((0, drizzle_orm_1.sql) `now()`),
});
exports.chatMembers = (0, pg_core_1.pgTable)("chat_members", {
    ...
    fk_user_id: (0, pg_core_1.integer)("fk_user_id")
        ...
        .notNull(),
    added_at: (0, pg_core_1.timestamp)("added_at")
        .notNull()
...
exports.privateMessages = (0, pg_core_1.pgTable)("private_messages", {
    ...
    fk_private_chat_id: (0, pg_core_1.integer)("fk_private_chat_id")
        .references(() => exports.privateChats.pk_private_chat_id, { onDelete: "cascade" }).notNull(),
    fk_user_id: (0, pg_core_1.integer)("fk_user_id")
        .references(() => exports.user.pk_user_id, { onDelete: "cascade" })
        .notNull(),
    message_text: (0, pg_core_1.text)("message_text"),
