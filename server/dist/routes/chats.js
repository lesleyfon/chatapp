"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="4f317569-9450-5f2c-be25-4f145ad2d17c")}catch(e){}}();
...
const query_handlers_model_1 = __importDefault(require("../model/query-handlers.model"));
...
const QueryHandlersMixin = (Base) => class extends Base {
    constructor(...args) {
        super(...args);
        this.queryHandlers = new query_handlers_model_1.default();
    }
};
...
class Chat extends (0, exports.AuthMiddlewareMixin)((0, exports.QueryHandlersMixin)(BaseClass)) {
    ...
    async getChatMessagesById(req, res) {
        try {
            ...
            const chatMessages = await this.queryHandlers.selectChatRoomMessagesByUserId(userId, Number.parseInt(chatId));
...
//# debugId=4f317569-9450-5f2c-be25-4f145ad2d17c
