...
ALTER TABLE "chat_members" ADD CONSTRAINT "chat_members_fk_chat_id_chats_pk_chats_id_fk" FOREIGN KEY ("fk_chat_id") REFERENCES "public"."chats"("pk_chats_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
